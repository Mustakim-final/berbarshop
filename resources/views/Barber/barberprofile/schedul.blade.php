            ...
            <div class="col-md-12">
                ...
                <div class="card card-primary">
                    <div class="card-header">
                        <h3 class="card-title">Set Schedul for <span style="color: yellow">{{ Auth::user()->name }}</span></h3>
                    </div>
                    ...
                    <!-- /.card-header -->
                    <!-- form start -->
                    <form method="POST" action="{{ route('barber.myschedulpost') }}"
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="time" class="form-control" name="time" id="exampleInputEmail1"
                            ...
                            <div class="form-group">
                                ...
                                <input type="time" class="form-control" name="end_time" id="exampleInputEmail1"
                                    placeholder="set time">
                            </div>
